...
class Users(CoreModel, AbstractUser):
    ...
    employee_no = models.CharField(max_length=150, unique=True, db_index=True, null=True, blank=True,
                                   verbose_name="employ", help_text="employ")
    email = models.EmailField(max_length=255, verbose_name="email", null=True, blank=True, help_text="email")
    mobile = models.CharField(max_length=255, verbose_name="mobile", null=True, blank=True, help_text="mobile")
    ...
    user_type = models.IntegerField(
        choices=USER_TYPE, default=0, verbose_name="user_type", null=True, blank=True, help_text="user_type"
    )
    post = models.ManyToManyField(to="Post", blank=True, verbose_name="post", db_constraint=False,
                                  help_text="post")
    role = models.ManyToManyField(to="Role", blank=True, verbose_name="role", db_constraint=False,
                                  help_text="role")
    ...
    last_token = models.CharField(max_length=255, null=True, blank=True, verbose_name="last_token",
                                  help_text="last_token")
