...
SECRET_KEY = "django-insecure--z8%exyzt7e_%i@1+#1mm=%lb5=^fx_57=1@a+_y7bg5-w%)sm3"
...
if USE_SQLITE == 1:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DBNAME', 'django_vue'),
            'USER': os.getenv('USERNAMEDB', 'postgres'),
            'PASSWORD': os.getenv('PASSWORDDBB', '123'),
            'HOST': os.getenv('HOSTDB', '127.0.0.1'),
